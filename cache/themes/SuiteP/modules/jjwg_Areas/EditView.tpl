...
{sugar_translate label='DEFAULT' module='jjwg_Areas'}
</div>
</a>
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_NAME' module='jjwg_Areas'}{/capture}
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='jjwg_Areas'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_CITY' module='jjwg_Areas'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_STATE' module='jjwg_Areas'}{/capture}
{$label|strip_semicolon}:
...
{/if}  
<input type='text' name='{$fields.state.name}' 
id='{$fields.state.name}' size='30' 
maxlength='255' 
value='{$value}' title='State'      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_COUNTRY' module='jjwg_Areas'}{/capture}
{$label|strip_semicolon}:
...
{/if}  
<input type='text' name='{$fields.country.name}' 
id='{$fields.country.name}' size='30' 
maxlength='255' 
value='{$value}' title='Country'      >
</div>
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_DESCRIPTION' module='jjwg_Areas'}{/capture}
{$label|strip_semicolon}:
...
{minify}
{capture name="label" assign="label"}{sugar_translate label='LBL_COORDINATES' module='jjwg_Areas'}{/capture}
{$label|strip_semicolon}:
...
{/literal}{literal}
<script type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'{/literal}{sugar_translate label='LBL_NAME' module='jjwg_Areas' for_js=true}{literal}' );
...
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_MODIFIED' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_MODIFIED_NAME' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'{/literal}{sugar_translate label='LBL_CREATED' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'created_by_name', 'relate', false,'{/literal}{sugar_translate label='LBL_CREATED' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'description', 'text', false,'{/literal}{sugar_translate label='LBL_DESCRIPTION' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'deleted', 'bool', false,'{/literal}{sugar_translate label='LBL_DELETED' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_ID' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'{/literal}{sugar_translate label='LBL_ASSIGNED_TO_NAME' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'city', 'varchar', false,'{/literal}{sugar_translate label='LBL_CITY' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'state', 'varchar', false,'{/literal}{sugar_translate label='LBL_STATE' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'country', 'varchar', false,'{/literal}{sugar_translate label='LBL_COUNTRY' module='jjwg_Areas' for_js=true}{literal}' );
addToValidate('EditView', 'coordinates', 'text', false,'{/literal}{sugar_translate label='LBL_COORDINATES' module='jjwg_Areas' for_js=true}{literal}' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'{/literal}{sugar_translate label='ERR_SQS_NO_MATCH_FIELD' module='jjwg_Areas' for_js=true}{literal}: {/literal}{sugar_translate label='LBL_ASSIGNED_TO' module='jjwg_Areas' for_js=true}{literal}', 'assigned_user_id' );
