...
{if $AUTHENTICATED}
    ...
    <footer>
        <div id="copyright_data">
            ...
            <div id="dialog" title="&copy; Apilink.com.mx">
                <p>Apilink.com.mx</p>
            </div>
            <div id="copyrightbuttons" class="footer_left">
                <a id="admin_optionsx">&copy; Apilink.com.mx</a>
                <a id="powered_byx">&copy; Apilink.com.mx</a>
            </div>
        </div>
    	<div class="footer_right">
    		
    		<a onclick="SUGAR.util.top();" href="javascript:void(0)">Apilink.com.mx<span class="suitepicon suitepicon-action-above"></span> </a>
    	</div>
    </footer>
    <!-- END Generic Footer -->
{/if}
